  ...
  const sendUpdateServiceRequest = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        serviceRequestDate: newRequest.serviceRequestDate,
      ...
      if (response) {
        ...
        resetForm();
        setShowCreateRequestForm(false); // Hide the form after update
      } else {
          ...
          >
            ...
            <div style={styles.formGroup}>
              ...
              <select
                ...
                onChange={(e) => setNewRequest((prev) => ({ ...prev, issueType: e.target.value }))}
                required
                style={styles.input}
              >
            ...
            <div style={styles.formGroup}>
              ...
              <input
                ...
                onChange={(e) => setNewRequest((prev) => ({ ...prev, serviceDescription: e.target.value }))}
                required
                style={styles.input}
              />
            </div>
            {newRequest.serviceId && decoded && decoded.role === "Admin" && (
              <div style={styles.formGroup}>
                ...
                <select
                  ...
                  onChange={(e) => setNewRequest((prev) => ({ ...prev, serviceReqStatus: e.target.value }))}
                  required
                  style={styles.input}
                >
